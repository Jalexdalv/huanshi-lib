...
public abstract class AbstractCommand implements TabExecutor {
    ...
    private boolean op, combating;
    private String permission, head;
    private List<String> argList;
    private final List<String> emptyTabList = new ArrayList<>();

    public void load(Environment environment, boolean op, boolean combating, @Nullable String permission, @NotNull String head, @NotNull String @NotNull [] args) {
    ...
    protected boolean onConsoleCommand(@NotNull CommandSender commandSender, @NotNull String @NotNull [] args) {
        return true;
    }
    ...
    public boolean canUse(@NotNull Player player) {
        if (!combating && combatService.isCombating(player.getUniqueId())) {
